    ...
    <aside className="flex h-full w-56 shrink-0 flex-col rounded-lg border border-zinc-800 bg-zinc-900/30">
      <div className="flex items-center justify-between border-b border-zinc-800 px-3 py-2">
        ...
        <button
          ...
          title="New project"
          className="rounded px-1.5 text-sm text-zinc-400 hover:bg-zinc-800 hover:text-zinc-100"
        >
          {adding ? "×" : "+"}
        </button>
      </div>
      ...
      {adding && (
        <div className="space-y-1.5 border-b border-zinc-800 p-2">
          <input
            ...
            placeholder="name"
            autoFocus
            className="w-full rounded-md border border-zinc-700 bg-zinc-900 px-2 py-1 text-sm outline-none focus:border-zinc-500"
          />
          <input
            value={path}
            ...
            className="w-full rounded-md border border-zinc-700 bg-zinc-900 px-2 py-1 font-mono text-[11px] outline-none focus:border-zinc-500"
          />
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className="absolute right-1 top-1.5 hidden rounded p-1 text-zinc-500 hover:bg-zinc-700 hover:text-red-300 group-hover:block"
                >
                  ✕
                </button>
              </div>
